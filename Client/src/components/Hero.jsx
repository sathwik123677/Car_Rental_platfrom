...
bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
    ...
    whileTap={{scale:0.95}}
     type="submit" className='flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary-dull text-white rounded-full cursor-pointer'>
        ...
        src={assets.main_car} alt="Main Car" className="max-h-74" />
    </motion.div>
  )
}
