...
const handleSearch = (e) => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
        <h1 className="text-4xl md:text-5xl font-semibold">Rent Your Dream Car Today!</h1> 
...
bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
    ...
    <button type="submit" className='flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary-dull text-white rounded-full cursor-pointer'>
